...
local swInputFocused = false    -- SimpleWhisper 입력창 포커스 상태 (Shift+클릭 링크 삽입용)
local swInputGraceUntil = 0     -- 포커스 손실 후 Shift+클릭 유예시간
...
if locale == "koKR" then
    ...
    L.OPT_HIDE_CHAT = "채팅창 귓속말 숨기기"
    L.OPT_INTERCEPT = "귓속말 보내기 사용"
    L.OPT_ESC_CLOSE = "ESC 클릭 즉시 닫기"
...
if locale == "zhCN" then
    L.TITLE         = "简易密语"
    L.LDB_LABEL     = "密语"
    L.CHAT_PREFIX   = "|cff00ccff[密语]|r"
    L.TOOLTIP_HINT  = "|cff00ff00点击|r切换窗口"
    L.NO_SELECTION  = "请在左侧选择一个对话。"
    L.SLASH_HELP    = "|cff00ccff/swsw|r — 切换密语窗口"
    L.CLOSE         = "关闭"
    L.ME            = "我"
    L.BTN_TIME      = "时间"
    L.BTN_DELETE    = "删除"
    ...
    L.BTN_CANCEL    = "取消"
    L.OPT_SOUND     = "通知音效"
    L.OPT_SOUND_SEL = "音效选择："
    L.OPT_AUTO_OPEN = "收到时自动打开"
    L.OPT_COMBAT    = "战斗中："
    L.COMBAT_1      = "立即"
    L.COMBAT_2      = "结束后"
    L.COMBAT_3      = "不打开"
    L.COMBAT_TIP_1  = "战斗中立即打开"
    L.COMBAT_TIP_2  = "战斗结束后打开"
    L.COMBAT_TIP_3  = "战斗中不打开"
    L.OPT_HIDE_CHAT = "聊天栏隐藏密语"
    L.OPT_INTERCEPT = "使用密语发送"
    L.OPT_ESC_CLOSE = "ESC立即关闭"
    ...
    L.SND_4         = "BNet"
    L.SND_5         = "自定义"
    L.URL_DIALOG    = "请复制此URL："
    L.CONFIRM_DELETE = "删除与 %s 的对话？"
    L.CONFIRM_DEL_ALL = "删除所有对话？\n（设置将保留）"
    L.CONFIRM_RESET = "重置所有设置？\n（对话将保留）"
    L.COPY_TITLE    = "Ctrl+C 复制"
    L.MSG_SOUND_ON  = "通知音效已开启。"
    L.MSG_SOUND_OFF = "通知音效已关闭。"
    L.MSG_CUSTOM_SND = "将 sw3.ogg 放入 SimpleWhisper/Sounds/ 文件夹。"
    L.MSG_AUTO_ON   = "收到密语时窗口将自动打开。"
    L.MSG_AUTO_OFF  = "收到密语时窗口不会自动打开。"
    L.MSG_HIDE_ON   = "密语已从聊天栏隐藏。"
    L.MSG_HIDE_OFF  = "密语将显示在聊天栏。"
    L.MSG_INTCPT_ON = "密语将在简易密语中打开。"
    L.MSG_INTCPT_OFF = "密语将在默认聊天栏打开。"
    L.MSG_ESC_ON    = "ESC将立即关闭窗口。"
    L.MSG_ESC_OFF   = "ESC将先取消焦点，再关闭。"
    L.MSG_ALL_DEL   = "所有对话已删除。"
    L.UNREAD_FMT    = "未读消息：|cffff3333%d|r"
    L.WHO_REFRESH   = "刷新"
    L.WHO_OFFLINE   = "离线"
    L.COPY_WHO      = "[查询]"
    L.COPY_SYS      = "[系统]"
    ...
    CLASS_NAME_TO_TOKEN = {
        ...
        ["萨满祭司"] = "SHAMAN", ["法师"] = "MAGE", ["术士"] = "WARLOCK",
        ["武僧"] = "MONK", ["德鲁伊"] = "DRUID", ["恶魔猎手"] = "DEMONHUNTER",
        ["唤魔师"] = "EVOKER",
    }
end

if locale == "deDE" then
    L.TITLE         = "SimpleWhisper"
    L.LDB_LABEL     = "Flüstern"
    L.CHAT_PREFIX   = "|cff00ccff[SW]|r"
    L.TOOLTIP_HINT  = "|cff00ff00Klick|r zum Umschalten"
    L.NO_SELECTION  = "Wähle links eine Unterhaltung."
    L.SLASH_HELP    = "|cff00ccff/swsw|r — Flüsterfenster umschalten"
    L.CLOSE         = "Schließen"
    L.ME            = "Ich"
    L.BTN_TIME      = "Zeit"
    ...
    L.OPT_SOUND     = "Benachrichtigungston"
    L.OPT_SOUND_SEL = "Ton :"
    L.OPT_AUTO_OPEN = "Auto-Öffnen bei Empfang"
    L.OPT_COMBAT    = "Im Kampf:"
    L.COMBAT_1      = "Sofort"
    L.COMBAT_2      = "Danach"
    L.COMBAT_3      = "Nie"
    L.COMBAT_TIP_1  = "Im Kampf sofort öffnen"
    L.COMBAT_TIP_2  = "Nach dem Kampf öffnen"
    L.COMBAT_TIP_3  = "Im Kampf nicht öffnen"
    L.OPT_HIDE_CHAT = "Flüstern im Chat verbergen"
    L.OPT_INTERCEPT = "Flüstern hier öffnen"
    L.OPT_ESC_CLOSE = "ESC schließt sofort"
    ...
    L.SND_4         = "BNet"
    L.SND_5         = "Eigener"
    L.URL_DIALOG    = "URL kopieren:"
    L.CONFIRM_DELETE = "Unterhaltung mit %s löschen?"
    L.CONFIRM_DEL_ALL = "Alle Unterhaltungen löschen?\n(Einstellungen bleiben erhalten)"
    L.CONFIRM_RESET = "Alle Einstellungen zurücksetzen?\n(Unterhaltungen bleiben erhalten)"
    L.COPY_TITLE    = "Strg+C zum Kopieren"
    L.MSG_SOUND_ON  = "Benachrichtigungston aktiviert."
    L.MSG_SOUND_OFF = "Benachrichtigungston deaktiviert."
    L.MSG_CUSTOM_SND = "Lege sw3.ogg in SimpleWhisper/Sounds/ ab."
    L.MSG_AUTO_ON   = "Fenster öffnet sich automatisch bei Flüstern."
    L.MSG_AUTO_OFF  = "Fenster öffnet sich nicht automatisch."
    L.MSG_HIDE_ON   = "Flüstern wird im Chat verborgen."
    L.MSG_HIDE_OFF  = "Flüstern wird im Chat angezeigt."
    L.MSG_INTCPT_ON = "Flüstern wird in SimpleWhisper geöffnet."
    L.MSG_INTCPT_OFF = "Flüstern wird im Standard-Chat geöffnet."
    L.MSG_ESC_ON    = "ESC schließt das Fenster sofort."
    L.MSG_ESC_OFF   = "ESC entfernt erst den Fokus, dann schließt."
    L.MSG_ALL_DEL   = "Alle Unterhaltungen gelöscht."
    L.UNREAD_FMT    = "Ungelesen: |cffff3333%d|r"
    L.WHO_REFRESH   = "Aktualisieren"
    L.WHO_OFFLINE   = "Offline"
    L.COPY_WHO      = "[Wer]"
    L.COPY_SYS      = "[System]"
    ...
    CLASS_NAME_TO_TOKEN = {
        ...
        ["Schurke"] = "ROGUE", ["Priester"] = "PRIEST", ["Todesritter"] = "DEATHKNIGHT",
        ["Schamane"] = "SHAMAN", ["Magier"] = "MAGE", ["Hexenmeister"] = "WARLOCK",
        ["Mönch"] = "MONK", ["Druide"] = "DRUID", ["Dämonenjäger"] = "DEMONHUNTER",
        ["Rufer"] = "EVOKER",
    }
end
...
local function CreateMainFrame()
    ...
    StaticPopupDialogs["SIMPLEWHISPER_RESET"] = {
        ...
        OnAccept = function()
            ...
            SimpleWhisper_DB.hideFromChat = true
            SimpleWhisper_DB.interceptWhisper = true
            SimpleWhisper_DB.escClose = false
            ...
            escCloseCheck:SetChecked(false)
            addonDisabled = false
            UpdateAddonStateBtns()
            SimpleWhisper_DB.presetBackup = nil
            UpdatePresetBtns()
    ...
    focusWatcher:Hide()
    inputBox:HookScript("OnEditFocusGained", function()
        focusWatcher:Show()
        swInputFocused = true
    end)
    inputBox:HookScript("OnEditFocusLost", function()
        focusWatcher:Hide()
        swInputFocused = false
        swInputGraceUntil = GetTime() + 0.3
    end)
    f.inputBox = inputBox
...
-- Shift+클릭 링크 삽입: SimpleWhisper 입력창이 포커스 상태면 우리 창에 삽입
-- ChatEdit_InsertLink 경로: 퀘스트/주문/업적 링크 (직접 호출됨)
-- HandleModifiedItemClick 경로: 아이템 링크 (activeWindow 없으면 ChatEdit_InsertLink를 호출하지 않고 리턴)
local swInserted = false
local function insertLinkToSW(text)
    if swInserted or not text then return end
    local box = _G.SimpleWhisperInputBox
    if not box or not box:IsVisible() then return end
    -- Shift+클릭 시 바깥 영역 클릭으로 포커스가 즉시 풀릴 수 있으므로
    -- 포커스 손실 직후 0.3초 유예시간까지 허용
    if swInputFocused or GetTime() < swInputGraceUntil then
        swInserted = true
        box:Insert(text)
        box:SetFocus()
        C_Timer.After(0, function() swInserted = false end)
    end
end

if ChatFrameUtil and ChatFrameUtil.InsertLink then
    hooksecurefunc(ChatFrameUtil, "InsertLink", insertLinkToSW)
elseif _G.ChatEdit_InsertLink then
    hooksecurefunc("ChatEdit_InsertLink", insertLinkToSW)
end
